...
- A: [Installation](https://github.com/eternal404/nitro-sniper/wiki/Installation)

<br />

- **Q: Where can I find the default configuration?**
- A: [Default Configuration](https://github.com/eternal404/nitro-sniper/wiki/Default-Configuration)
