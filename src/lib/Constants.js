...
module.exports = {
   ...
   invalidConfig: 'Invalid settings, please visit the FAQ for more information: https://github.com/localip/nitro-sniper#faq. Exiting process...',
   noMode: 'No sniper mode provided in settings, exiting process...',
   invalidMode: 'Invalid mode provided, visit https://github.com/localip/nitro-sniper#default-configuration for a list of modes. Exiting process...',
